...
alias gitp='git push'
alias ansdoc='ansible-doc $(rg -g "!test/" -g "!tests/" -g "!module_utils/" -g "!doc_fragments/" -g "!cliconf/" -g "!terminal/" -g "!action/" -g "!httpapi/" -g "!callback/" --iglob "*.py" --iglob "!__init__.py" --files /usr/lib/python3.8/site-packages/ansible_collections/ /usr/lib/python3.8/site-packages/ansible/modules/ | sed -e 's!.*/!!' -e 's/\\\\.py//g' | fzf)'
